...
window.onload = function () {
    ...
    showInfo()
            showPages()
            weak()
            var container = document.getElementById('container_coffer');
            ...
            function animate(offset) {
                ...
                //且style.left获取的是字符串（带有单位），需要用parseInt()取整转化为数字。
...
function weak() {
    var now = new Date()
    var sunday = new Date("2019-8-15 24:0:0")
    var time = sunday - now
    time = time / 1000
    ...
    var spans = document.getElementById('container_coffer').getElementsByTagName('span')
