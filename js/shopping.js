...
window.onscroll = function () {
    ...
    var oRightHead = document.getElementById('rightHead')
    if (scroH >= 80) {
    ...
    if (scroH >= 550 && scroH <=1500) {
        oRightHead.style.position = 'fixed'
        oRightHead.style.top = '120px'
        oRightHead.style.right = '20px'
    }else{
        oRightHead.style.position = 'absolute'
